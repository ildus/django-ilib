...
var tree_object_id_field_name = 'object_id';

function myAddAnotherPopup(triggeringLink, field_name) {
    ...
    if (tree_content_type) {
    	href += '&content_type='+tree_content_type;
    }
    
    if (!field_name) field_name = tree_object_id_field_name;
    
    if (tree_object_id) {
    	href += '&'+field_name+'='+tree_object_id;
    }
...
function add_child(link) {
	myAddAnotherPopup(link);
